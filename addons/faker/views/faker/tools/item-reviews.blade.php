...
@section('title', translate('Fake Item Reviews'))
...
@section('content')
    <div class="alert alert-primary">
        ...
        <ol class="m-0">
            ...
            <li class="mb-1">
                {{ translate('The item should have sales more than number of reviews you want to generate.') }}
            </li>
            <li>
                {{ translate('This tool will increase the item and author ratings.') }}
            </li>
        </ol>
    </div>
    <div class="card mb-3">
