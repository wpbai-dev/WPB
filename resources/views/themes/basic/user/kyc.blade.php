...
@section('title', translate('KYC Verification'))
@section('breadcrumbs', Breadcrumbs::render('user.kyc'))
@section('content')
    @if (authUser()->isKycPending())
        <div class="box box-empty text-center">
            <div class="mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="200px" height="200px" viewBox="0 0 892.6139 540.80203"
            ...
            <div class="col-12 col-xxl-6 m-auto">
                <p class="mb-0">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div id="passportNumber" class="d-none">
                                ...
                                <input type="text" name="passport_number" class="form-control form-control-md">
                            </div>
                        </div>
                    </div>
                </div>
