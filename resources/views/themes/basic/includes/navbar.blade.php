<div class="top-nav-bar">
    <div class="container container-custom">
        <div class="top-nav-inner">
            <nav class="top-nav-links" data-topnav-panel>
                @php
                    $topMenu = [
                        ['label' => 'Home',        'url' => route('home')],
                        ['label' => 'New Update',  'url' => url('/updates')],
                        ['label' => 'Brand',       'url' => url('/brands')],
                        ['label' => 'Free Items',  'url' => url('/free')],
                        ['label' => 'Blog',        'url' => url('/blog')],
                        ['label' => 'DMCA',        'url' => url('/dmca')],
                        ['label' => 'Contact',     'url' => url('/contact-us')],
                    ];
                    $isActive = fn(string $u) => url()->current() === $u ? 'active' : '';
                @endphp

                @foreach ($topMenu as $item)
                    <a href="{{ $item['url'] }}" class="top-link {{ $isActive($item['url']) }}">
